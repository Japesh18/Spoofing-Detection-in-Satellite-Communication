...
def extract_features_from_url(url,dataset_name,label,window_size=100000,percentage=0.1):
...
datasets={
    ...
    "DS1":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds1.bin","label":1},
    "DS2":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds2.bin","label":1},
    "DS3":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds3.bin","label":1},
    "DS4":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds4.bin","label":1},
    "DS5":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds5.bin","label":1},
    "DS6":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds6.bin","label":1},
    "DS7":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds7.bin","label":1},
    "DS8":{"url":"https://rnl-data.ae.utexas.edu/datastore/texbat/ds8.bin","label":1},
}
all_rows=[]
for name,info in datasets.items():
    print(f"\nProcessing {name}...")
    rows=extract_features_from_url(url=info["url"],dataset_name=name,label=info["label"],window_size=100000,percentage=0.1)
